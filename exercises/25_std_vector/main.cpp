...
int main(int argc, char **argv) {
    {
        ...
        ASSERT(sizeof(vec) == vec.size() * sizeof(vec[0]), "Fill in the correct value.");
        int ans[]{1, 2, 3, 4, 5};
    ...
    }
    {
        ...
        }
        {
            ...
            vec.insert(vec.begin() + 1, 1.5);//插入一个数
    ...
    }
    {
        ...
        ASSERT(sizeof(vec) == 48, "Fill in the correct value.");
        {
            ...
            vec.resize(16);
            ASSERT(vec.size() == 48, "Fill in the correct value.");
        ...
        }
        {
            ...
            vec.push_back('c');
            vec.push_back('d');
            ASSERT(vec.size() == 260, "Fill in the correct value.");
